...
def main(group_name):
    BLOG_URL_PATH = f'/home/ubuntu/work/python/api/scraping/{group_name}/blogUrls.txt'
    BLOG_INFO_PATH = f'/home/ubuntu/work/python/api/batch/blog_infos/{group_name}.txt'
    ...
    with open(f'/home/ubuntu/work/python/api/batch/outputs/{group_name}.json', 'w') as f:
